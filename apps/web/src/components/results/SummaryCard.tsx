                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                {item.files.map((f) => (
                                    <span
                                        key={f.name}
                                        className="text-xs bg-white border border-slate-200/80 text-slate-700 rounded-md px-2 py-1 font-mono shadow-2xs"
                                    >
                                        {f.name}
                                    </span>
                                ))}
                                {item.extraFiles && item.extraFiles > 0 && (
                                    <span className="text-xs bg-blue-50 border border-blue-100/80 text-blue-700 font-medium rounded-md px-2 py-1">
                    ...
                    {item.variant === "typography" && item.mapping && (
                        <div>
                            ...
                            {item.mapping.matchLabel && (
                                <div className="pt-2 mt-2 border-t border-slate-200/60 flex items-start gap-1.5 text-xs text-slate-500">
