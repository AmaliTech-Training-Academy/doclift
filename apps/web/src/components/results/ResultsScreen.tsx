            ...
            <div className="bg-white w-full mx-auto max-w-5xl flex flex-col space-y-4 p-4 rounded-xl">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="flex flex-col gap-2 min-w-0 flex-1">
                        <div className="w-fit flex flex-col text-sm sm:flex-row gap-2 bg-primary-background p-2 rounded-xl sm:items-center">
            ...
            <div className="w-full mx-auto max-w-5xl grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col space-y-3 bg-white p-4 rounded-xl">
                    <div className="flex flex-row justify-between items-center mb-3">
                        ...
                        <span className="text-sm text-muted-foreground">Deterministic AST Validation</span>
                    </div>
                ...
                <div className="flex flex-col space-y-3 bg-white p-4 rounded-xl">
                    <div className="flex flex-row justify-between items-center mb-3">
                        ...
                        <span className="text-sm text-muted-foreground">Target: Exact DOCX</span>
                    </div>
                    ...
                    <div className="flex flex-row items-start gap-3 bg-primary-background border border-primary-foreground rounded-xl p-3 mt-1">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-primary mb-0.5">DocLift Transparency Principle</p>
