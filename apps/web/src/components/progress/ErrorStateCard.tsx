    ...
    <div className="w-full py-12 flex justify-center items-center">
      ...
      <Card className="m-2 flex flex-col w-full max-w-md overflow-hidden shadow-lg border-red-100">
        ...
        <div className="flex flex-col text-center justify-center p-6 space-y-2">
          ...
          <p className="text-base text-foreground font-medium">An error has occurred. Your File conversion failed.</p>
          <p className="text-sm text-muted-foreground">
            Please try again later.
          </p>
        </div>
        <div className="p-4 pt-0 flex justify-center">
          <Button variant="danger" className="min-w-36" onClick={resetKeepFile}>
            Retry
          </Button>
        </div>
      </Card>
